...
- `file` (binary): The document file to be uploaded.

**Example Bulk Edit Request Body**:

``` json
document_id:DT000000000084
document_type:Existing all-risk insurance policy
name:0516000010.pdf
document_desc:
    ...
    "data": [
        {
            ...
            "document": {
                ...
                "quote_no": "",
                "ready_state": 0,
                "status_desc": "{\"Existing all-risk insurance policy\":\"not-uploaded\",\"As-built engineering drawings\":\"not-uploaded\",\"Active O&M contract\":\"uploaded\",\"Loss runs from the site\":\"not-uploaded\"}",
                "status": 0,
                "created_by": "broker@sunereum.cloware.in",
                "assigned_to": "broker@sunereum.cloware.in",
                "proxy": "",
